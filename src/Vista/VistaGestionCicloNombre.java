...
public class VistaGestionCicloNombre extends javax.swing.JFrame {
    ...
    private void Guardar() throws ListaVacia {
        if (txtCodigoCurso.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Falta llenar el nombre del ciclo", "Error",
            ...
            if (nombreCicloExiste(nuevoNombreCiclo)) {
                JOptionPane.showMessageDialog(null, "El nombre del ciclo ya existe", "NOMBRE DE CICLO EXISTENTE",
            ...
            try {
                ...
                if (codigoCursoControlDao.Persist()) {
                    JOptionPane.showMessageDialog(null, "NOMBRE DE CICLO GUARDADO EXITOSAMENTE", "INFORMACION",
                            JOptionPane.INFORMATION_MESSAGE);
                    codigoCursoControlDao.setNombreCiclo(null);
                }
                else {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel2Layout.createSequentialGroup().addGap(150, 150, 150)
                        ...
                        .addGap(43, 43, 43).addComponent(jLabel2).addContainerGap(401, Short.MAX_VALUE)));
        ...
        jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel1Layout.createSequentialGroup().addContainerGap()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(
                                        jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 273,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout
                                        .createSequentialGroup().addComponent(btnRegresar)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
        ...
        jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jLabel4).addComponent(txtCodigoCurso,
                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            if (cbxTipoBusqueda.getSelectedIndex() == -1) {
                ...
                ListaDinamica<NombreCiclo> ResultadoBusqueda = UtilesControlador.BusquedaLineal(lista, Campo,
                        TipoCampo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaGestionCicloNombre.class.getName())
