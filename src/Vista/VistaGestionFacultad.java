...
public class VistaGestionFacultad extends javax.swing.JFrame {
    ...
    private void Seleccionar() {
        ...
        if (fila < 0) {
            ...
            try {
                ...
                cbxUniversidad
                        .setSelectedIndex(facultadControlDao.getFacultades().getUniversidadFacultad().getIdU() - 1);
    ...
    private void Guardar() throws ListaVacia {
        ...
        if (txtNombre.getText().isEmpty()) {
            ...
            JOptionPane.showMessageDialog(null, "La fecha de la creacion de la facultad no puede ser futura", "Error",
            ...
            if (facultadExiste(nuevaFacultad)) {
                JOptionPane.showMessageDialog(null, "La facultad ya existe", "FACULTAD EXISTENTE",
            ...
            try {
                ...
                if (facultadControlDao.Persist()) {
                    JOptionPane.showMessageDialog(null, "FACULTAD GUARDADA EXITOSAMENTE", "INFORMACION",
                            JOptionPane.INFORMATION_MESSAGE);
                    facultadControlDao.setFacultades(null);
                }
                else {
    ...
    private void initComponents() {
        ...
        cbxTipoBusqueda.setModel(
                new javax.swing.DefaultComboBoxModel<>(new String[] { "Nombre", "Fecha de creacion", "Universidad" }));
        ...
        tblDocentes.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
                ...
                .addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addGroup(jPanel1Layout
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING,
                                        ...
                                        .addGroup(jPanel1Layout.createSequentialGroup().addComponent(jLabel5)
                                                ...
                                                .addComponent(DateFechaC, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                        ...
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                .addComponent(jLabel6, javax.swing.GroupLayout.PREFERRED_SIZE, 74,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(txtNombre, javax.swing.GroupLayout.PREFERRED_SIZE, 229,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        .addComponent(cbxUniversidad, javax.swing.GroupLayout.PREFERRED_SIZE, 229,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                ...
                                .addComponent(cbxTipoBusqueda, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(jLabel10).addComponent(cbxUniversidad,
                                        javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanel1Layout.createSequentialGroup().addGap(2, 2, 2).addComponent(
                                        jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 439, Short.MAX_VALUE))
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addGroup(jPanel1Layout
                                                .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        ...
                                        .addGroup(jPanel1Layout
                                                .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addComponent(jLabel5).addComponent(DateFechaC,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                        ...
                        .addGap(10, 10, 10)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(jButton1).addComponent(jButton4).addComponent(jButton5)
                                .addComponent(jButton2))
                        .addContainerGap()));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (fila < 0) {
            ...
            if (txtNombre.getText().isEmpty()) {
                ...
                JOptionPane.showMessageDialog(null, "La fecha de la creacion de la facultad no puede ser futura",
                        "Error", JOptionPane.WARNING_MESSAGE);
            }
            else if (cbxUniversidad.getSelectedIndex() == -1) {
                JOptionPane.showMessageDialog(null, "Falta seleccionar universidad", "Error",
                        JOptionPane.WARNING_MESSAGE);
            }
            else {
                ...
                // Universidad U = new Universidad(1, "Universidad Nacional de Loja", "AV. Pio
                // Jaramillo", "(07) 254-7252", "masinfo@unl.edu.ec", "31 de diciembre de
                // 1859");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            if (cbxTipoBusqueda.getSelectedIndex() == -1) {
                JOptionPane.showMessageDialog(null, "Por favor seleccione donde quiere buscar", "Error",
                        JOptionPane.WARNING_MESSAGE);
            }
            else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaGestionFacultad.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
        }
