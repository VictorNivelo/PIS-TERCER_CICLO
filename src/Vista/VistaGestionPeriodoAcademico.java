...
public class VistaGestionPeriodoAcademico extends javax.swing.JFrame {
    ...
    private void Guardar() throws ListaVacia {
        ...
        if (fechaInicio == null) {
            JOptionPane.showMessageDialog(null, "Falta llenar la fecha de inicio", "Error",
            ...
            JOptionPane.showMessageDialog(null, "La fecha de inicio no puede ser igual a la fecha de fin", "Error",
                    JOptionPane.WARNING_MESSAGE);
        }
        else if (fechaFin.before(fechaInicio)) {
            JOptionPane.showMessageDialog(null, "La fecha de fin no puede ser antes de la fecha de inicio", "Error",
                    JOptionPane.WARNING_MESSAGE);
        }
        else if (fechaInicio.after(fechaFin)) {
            JOptionPane.showMessageDialog(null, "La fecha de inicio no puede ser después de la fecha de fin", "Error",
                    JOptionPane.WARNING_MESSAGE);
        }
        else if (cbxEstadoPeriodo.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(null, "Falta seleccionar el estado del período", "Error",
                    JOptionPane.WARNING_MESSAGE);
        }
        else {
            ...
            if (periodoExiste(nuevoPeriodo)) {
                ...
                try {
                    if (periodoControlDao.persist()) {
                        JOptionPane.showMessageDialog(null, "Período guardado exitosamente", "Información",
                                JOptionPane.INFORMATION_MESSAGE);
                        periodoControlDao.setPeriodo(null);
                    }
                    else {
                        JOptionPane.showMessageDialog(null, "No se pudo guardar el período", "Información",
                                JOptionPane.INFORMATION_MESSAGE);
                    }
                }
                catch (Exception e) {
    ...
    private void initComponents() {
        ...
        tblPeriodos.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
        ...
        cbxTipoBusqueda.setModel(
                new javax.swing.DefaultComboBoxModel<>(new String[] { "Fecha de inicio", "Fecha fin", "Estado" }));
        ...
        jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel2Layout.createSequentialGroup().addContainerGap().addGroup(jPanel2Layout
                        ...
                        .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 283,
                                javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(DateFin, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(DateInicio, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                        .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(jLabel9, javax.swing.GroupLayout.PREFERRED_SIZE, 76,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(
                                        cbxEstadoPeriodo, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(jScrollPane1)
                                .addGroup(jPanel2Layout.createSequentialGroup().addGap(6, 6, 6).addComponent(jLabel7)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        ...
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                .addGroup(jPanel2Layout
                                                        ...
                                                        .addComponent(jLabel4).addComponent(
                                                                DateInicio, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addGroup(jPanel2Layout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                                        .addComponent(jLabel5).addComponent(DateFin,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addGroup(jPanel2Layout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                        .addComponent(jLabel9).addComponent(cbxEstadoPeriodo,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            if (cbxTipoBusqueda.getSelectedIndex() == -1) {
                ...
                ListaDinamica<PeriodoAcademico> ResultadoBusqueda = UtilesControlador.BusquedaLineal(lista, Campo,
                        TipoCampo);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (fila < 0) {
            ...
            if (DateInicio.getDate() == null) {
                JOptionPane.showMessageDialog(null, "Falta llenar decha de inicio", "Error",
                        JOptionPane.WARNING_MESSAGE);
            }
    ...
    private void btnOrdenarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnOrdenarActionPerformed
        ...
        try {
            if (cbxTipoOrden.getSelectedIndex() == -1) {
                ...
                ListaDinamica<PeriodoAcademico> resultadoOrdenado = UtilesControlador.QuickSort(lista, orden,
                        TipoCampo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaGestionPeriodoAcademico.class.getName())
