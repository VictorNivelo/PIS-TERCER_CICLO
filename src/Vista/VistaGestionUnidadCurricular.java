...
public class VistaGestionUnidadCurricular extends javax.swing.JFrame {
        ...
        if (fila < 0) {
            ...
            try {
                ...
                txtDescripcionUnidad
                        .setText(unidadCurricularControlDao.getUnidadCurriculares().getDescripcionUnidadCurricular());
                cbxMalla.setSelectedIndex(unidadCurricularControlDao.getUnidadCurriculares()
                        .getMallaCurricularUnidadCurricular().getIdMallaCurricular() - 1);
            }
            catch (Exception e) {
    ...
    private String generarCodigo() throws ListaVacia {
        ...
        try {
            ListaDinamica<UnidadCurricular> listaPresentacion = (ListaDinamica<UnidadCurricular>) Bridge.getConection()
    ...
    private boolean unidadCurricularExiste(UnidadCurricular nuevaUnidadCurricular) {
        ...
        for (UnidadCurricular unidad : unidades.toArray()) {
            if (unidad.getNombreUnidadCurricular().equals(nuevaUnidadCurricular.getNombreUnidadCurricular())
                    && unidad.getDescripcionUnidadCurricular()
                            .equals(nuevaUnidadCurricular.getDescripcionUnidadCurricular())
                    && unidad.getMallaCurricularUnidadCurricular().getIdMallaCurricular().equals(
                            nuevaUnidadCurricular.getMallaCurricularUnidadCurricular().getIdMallaCurricular())) {
                return true;
            }
        }
        return false;
    ...
    private void Guardar() throws ListaVacia {
        if (txtNombreUnidad.getText().isEmpty()) {
            ...
            if (unidadCurricularExiste(nuevaUnidadCurricular)) {
                JOptionPane.showMessageDialog(null, "La unidad curricular ya existe", "UNIDAD CURRICULAR EXISTENTE",
            ...
            try {
                ...
                if (unidadCurricularControlDao.Persist()) {
                    JOptionPane.showMessageDialog(null, "UNIDAD CURRICULAR GUARDADA EXITOSAMENTE", "INFORMACION",
                            JOptionPane.INFORMATION_MESSAGE);
                    unidadCurricularControlDao.setUnidadCurriculares(null);
                }
                else {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel2Layout.createSequentialGroup().addGap(150, 150, 150)
                        ...
                        .addGap(18, 18, 18).addComponent(jLabel2).addContainerGap(255, Short.MAX_VALUE)));
        ...
        cbxTipoBusqueda.setModel(
                new javax.swing.DefaultComboBoxModel<>(new String[] { "Codigo", "Nombre", "Descripcion", "Malla" }));
        cbxTipoBusqueda.setSelectedIndex(-1);
        ...
        tblUnidadCurrricular.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
        ...
        jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addGroup(jPanel1Layout
                        ...
                        .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 279,
                                javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(txtCodigoUnidad).addComponent(txtNombreUnidad).addComponent(
                                                cbxMalla, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
        ...
        jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                ...
                                .addComponent(txtCodigoUnidad, javax.swing.GroupLayout.PREFERRED_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGroup(jPanel1Layout
                                                .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                .addComponent(jLabel5).addComponent(txtNombreUnidad,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addGroup(jPanel1Layout
                                                .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                .addComponent(jLabel6).addComponent(txtDescripcionUnidad,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addGroup(jPanel1Layout
                                                .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                .addComponent(jLabel7).addComponent(cbxMalla,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnOrdenarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnOrdenarActionPerformed
        ...
        try {
            if (cbxTipoOrden.getSelectedIndex() == -1) {
                ...
                ListaDinamica<UnidadCurricular> resultadoOrdenado = UtilesControlador.QuickSort(lista, orden,
                        TipoCampo);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            if (cbxTipoBusqueda.getSelectedIndex() == -1) {
                ...
                ListaDinamica<UnidadCurricular> ResultadoBusqueda = UtilesControlador.BusquedaLineal(lista, Campo,
                        TipoCampo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaGestionUnidadCurricular.class.getName())
