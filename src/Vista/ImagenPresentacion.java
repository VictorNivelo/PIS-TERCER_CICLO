...
public class ImagenPresentacion extends javax.swing.JFrame {
    ...
    // Image imagen = imagenIcon.getImage().getScaledInstance(ancho, alto,
    // Image.SCALE_SMOOTH);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ImagenPresentacion.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
        }
