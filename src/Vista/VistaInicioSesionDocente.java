...
public class VistaInicioSesionDocente extends javax.swing.JFrame {
    ...
    private void VerificarUsuario() {
        ...
        for (Cursa materia : listaCursa.toArray()) {
            ...
            if (cuenta != null && cuenta.getCorreo().equals(usuarioIngresado)
                ...
                if (materia.getDocenteCursa().getDatosDocente().getRolPersona() != null && materia.getDocenteCursa()
                        .getDatosDocente().getRolPersona().getNombreRol().equals("Docente")) {
                    esDocente = true;
                    ...
                    JOptionPane.showMessageDialog(null, "Solo los docentes pueden acceder ", "ACCESO DENEGADO",
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup().addGap(411, 411, 411).addComponent(
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaInicioSesionDocente.class.getName())
