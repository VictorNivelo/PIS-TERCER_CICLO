...
public class VistaInicioSesionEstudiante extends javax.swing.JFrame {
    ...
    private void VerificarAccesoAlumno() {
        ListaDinamica<Cursa> listaMatriculas = cursaControlDao.all();
        ...
        for (Cursa matricula : listaMatriculas.toArray()) {
            Cuenta cuenta = matricula.getMatriculaCursa().getAlumnoMatricula().getDatosAlumno().getCuentaPersona();
            if (cuenta != null && cuenta.getCorreo().equals(usuarioIngresado)
                    && cuenta.getContrasena().equals(contrasenaIngresada)) {
                credencialesCorrectas = true;
                if (matricula.getMatriculaCursa().getAlumnoMatricula().getDatosAlumno().getRolPersona() != null
                        && matricula.getMatriculaCursa().getAlumnoMatricula().getDatosAlumno().getRolPersona()
                                .getNombreRol().equals("Estudiante")) {
                    esAlumno = true;
                    alumnoLogeado = matricula.getMatriculaCursa().getAlumnoMatricula();
                    String nombre = matricula.getMatriculaCursa().getAlumnoMatricula().getDatosAlumno().getNombre();
                    String apellido = matricula.getMatriculaCursa().getAlumnoMatricula().getDatosAlumno().getApellido();
                    nombreUsuario = nombre + " " + apellido;
                    break;
                }
                else {
                    JOptionPane.showMessageDialog(null, "Solo los alumnos pueden acceder ", "ACCESO DENEGADO",
        ...
        if (credencialesCorrectas && esAlumno) {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel2Layout.createSequentialGroup().addGap(148, 148, 148).addComponent(jLabel2)
                        .addGap(34, 34, 34).addComponent(jLabel1).addContainerGap(232, Short.MAX_VALUE)));
        ...
        bordesRedondos1Layout.setHorizontalGroup(
                bordesRedondos1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                        javax.swing.GroupLayout.Alignment.TRAILING,
                        bordesRedondos1Layout.createSequentialGroup().addContainerGap(27, Short.MAX_VALUE)
                                .addGroup(bordesRedondos1Layout
                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(btnIniciarSeccion, javax.swing.GroupLayout.DEFAULT_SIZE,
                                ...
                                .addGap(27, 27, 27)));
        bordesRedondos1Layout.setVerticalGroup(bordesRedondos1Layout
                .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(bordesRedondos1Layout.createSequentialGroup().addGap(30, 30, 30).addComponent(jLabel3)
                        ...
                        .addComponent(txtContrasenia, javax.swing.GroupLayout.PREFERRED_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18).addComponent(btnIniciarSeccion, javax.swing.GroupLayout.PREFERRED_SIZE, 44,
        ...
        jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jPanel2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
                        Short.MAX_VALUE)
                .addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addComponent(btnRegresar)
                        .addContainerGap(1063, Short.MAX_VALUE))
                .addGroup(jPanel1Layout.createSequentialGroup().addGap(411, 411, 411)
    ...
    private void btnIniciarSeccionActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnIniciarSeccionActionPerformed
        ...
        if (txtCorreo.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Por favor, ingrese su correo.", "CORREO VACIO",
                    JOptionPane.INFORMATION_MESSAGE);
        }
        else if (contrasenaIngresada.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Por favor, ingrese su contraseña.", "CONTRESEÑA VACIA",
                    JOptionPane.INFORMATION_MESSAGE);
        }
        else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaInicioSesionEstudiante.class.getName())
