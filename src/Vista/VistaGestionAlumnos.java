...
public class VistaGestionAlumnos extends javax.swing.JFrame {
    ...
    private void Guardar() throws ListaVacia {
        if (cbxAlumno.getSelectedIndex() == -1) {
            ...
            JOptionPane.showMessageDialog(null, "Falta seleccionar el estado del alumno", "Error",
            ...
            try {
                if (alumnoControlDao.Persist()) {
                    JOptionPane.showMessageDialog(null, "Alumno guardado exitosamente", "Información",
                            JOptionPane.INFORMATION_MESSAGE);
                    alumnoControlDao.setAlumnos(null);
                }
                else {
                    JOptionPane.showMessageDialog(null, "No se pudo guardar el alumno", "Error",
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel2Layout.createSequentialGroup().addGap(150, 150, 150)
                        ...
                        .addGap(104, 104, 104).addComponent(jLabel2).addContainerGap(321, Short.MAX_VALUE)));
                ...
                .addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addGroup(jPanel1Layout
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(cbxEstado, 0, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                Short.MAX_VALUE)
                                        .addComponent(cbxAlumno, 0, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                Short.MAX_VALUE)))
                                                ...
                                                .addGroup(jPanel1Layout
                                                        ...
                                                        .addGroup(jPanel1Layout
                                                                ...
                                                                .addComponent(txtBuscar,
                                                                        ...
                                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                .addComponent(jLabel11).addComponent(txtAlumnoBusqueda,
                                                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                        javax.swing.GroupLayout.PREFERRED_SIZE))))
                                        .addGroup(jPanel1Layout.createSequentialGroup().addComponent(btnOrdenar)
                                                .addGap(34, 34, 34))
                                        .addGroup(jPanel1Layout.createSequentialGroup().addComponent(jButton3).addGap(1,
                                                1, 1)))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel1Layout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                        .addComponent(jLabel6).addComponent(cbxEstado,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton4ActionPerformed
        ...
        int fila = tblAlumnos.getSelectedRow();
        if (fila < 0) {
            JOptionPane.showMessageDialog(null, "Escoga un registro", "REGISTRO NO SELECCIONADO",
                    JOptionPane.WARNING_MESSAGE);
        }
        else {
            if (cbxAlumno.getSelectedIndex() == -1) {
    ...
    private void txtAlumnoBusquedaKeyTyped(java.awt.event.KeyEvent evt) {// GEN-FIRST:event_txtAlumnoBusquedaKeyTyped
        ...
        // }
        // if (txtAlumnoBusqueda.getText().length() >= 10 && c !=
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaGestionAlumnos.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
        }
