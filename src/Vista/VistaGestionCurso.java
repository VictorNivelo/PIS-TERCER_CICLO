...
public class VistaGestionCurso extends javax.swing.JFrame {
    ...
    /*
     * casi sirve if (cbxCodigoCurso.getSelectedIndex() == -1) {
     * JOptionPane.showMessageDialog(null, "Falta seleccionar el ciclo", "Error",
     * JOptionPane.ERROR_MESSAGE); } else if (cbxParalelo.getSelectedIndex() == -1)
     * { JOptionPane.showMessageDialog(null, "Falta seleccionar materia", "Error",
     * JOptionPane.ERROR_MESSAGE); } else if (cbxMatricula.getSelectedIndex() == -1)
     * { JOptionPane.showMessageDialog(null, "Falta seleccionar materia", "Error",
     * JOptionPane.ERROR_MESSAGE); } else { Paralelo paralelo =
     * UtilVista.obtenerControlParalelo(cbxParalelo); Matricula matricula =
     * UtilVista.obtenerMatriculaControl(cbxMatricula);
     * 
     * // Obtener el nombre del código del curso String nombreCodigoCurso =
     * cbxCodigoCurso.getSelectedItem().toString();
     * 
     * // Crear un objeto CodigoCurso con el nombre obtenido CodigoCurso codigoCurso
     * = new CodigoCurso(); codigoCurso.setNombreCodigoCurso(nombreCodigoCurso);
     * 
     * // Buscar si ya existe un curso con el mismo código y paralelo boolean
     * cursoExistenteEncontrado = false; for (int i = 0; i <
     * listaCursos.getLongitud(); i++) { Cursa curso = listaCursos.getInfo(i); if
     * (curso.getCodigoCursoCursa().getNombreCodigoCurso().equals(nombreCodigoCurso)
     * && curso.getParaleloCursa().equals(paralelo)) { // Si ya existe un curso con
     * el mismo código y paralelo, agregar la matrícula a su lista de matrículas
     * curso.getListaMatriculaCursa().Agregar(matricula); cursoExistenteEncontrado =
     * true; cursoControlDao.setCursos(curso); // Actualizar el curso en el DAO
     * break; } }
     * 
     * if (!cursoExistenteEncontrado) { // Si no existe un curso con el mismo código
     * y paralelo, crear un nuevo curso y agregar la matrícula a su lista de
     * matrículas Integer idCiclo = listaCursos.getLongitud() + 1; Cursa nuevoCurso
     * = new Cursa(); nuevoCurso.setIdCurso(idCiclo);
     * nuevoCurso.setCodigoCursoCursa(codigoCurso);
     * nuevoCurso.setParaleloCursa(paralelo); ListaDinamica<Matricula>
     * listaMatriculasAgregar = new ListaDinamica<>();
     ...
     * 
     * if (cursoControlDao.Persist()) { JOptionPane.showMessageDialog(null,
     * "CICLO GUARDADO EXITOSAMENTE", "INFORMACION",
     * JOptionPane.INFORMATION_MESSAGE); cursoControlDao.setCursos(null); } else {
     * JOptionPane.showMessageDialog(null, "NO SE PUEDE REGISTRAR", "INFORMACION",
     * JOptionPane.INFORMATION_MESSAGE); } Limpiar(); }
     */
    ...
    private String generarCodigo() throws ListaVacia {
        ...
        try {
            ListaDinamica<Cursa> listaPresentacion = (ListaDinamica<Cursa>) Bridge.getConection()
    ...
    private void Guardar() throws ListaVacia {
        ...
        if (cbxParalelo.getSelectedIndex() == -1) {
            ...
            if (cursoControlDao.Persist()) {
                JOptionPane.showMessageDialog(null, "CURSO GUARDADA EXISTOSAMENTE", "INFORMACION",
    ...
    //
    // if (cursoControlDao.Persist()) {
    // JOptionPane.showMessageDialog(null, "CICLO GUARDADO EXITOSAMENTE",
    ...
    //
    // if (cursoControlDao.Persist()) {
    // JOptionPane.showMessageDialog(null, "CICLO GUARDADA EXISTOSAMENTE",
    // "INFORMACION", JOptionPane.INFORMATION_MESSAGE);
    // cursoControlDao.setCursos(null);
    // }
    // else {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel2Layout.createSequentialGroup().addGap(150, 150, 150)
                        ...
                        .addGap(82, 82, 82).addComponent(jLabel2).addContainerGap(261, Short.MAX_VALUE)));
        ...
        tblCursos.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
        ...
        cbxTipoOrden.setModel(new javax.swing.DefaultComboBoxModel<>(
                new String[] { "Codigo", "Paralelo", "DNI estudiante", "DNI dodente" }));
        cbxTipoOrden.setSelectedIndex(-1);
        ...
        jButton3.setIcon(
                new javax.swing.ImageIcon(getClass().getResource("/Vista/RecursosGraficos/Botones/Agregar.png"))); // NOI18N
                ...
                .addGroup(jPanel1Layout.createSequentialGroup().addContainerGap()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                        jPanel1Layout.createSequentialGroup().addComponent(jButton2)
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup().addComponent(jLabel7)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(cbxMatricula, 0, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                Short.MAX_VALUE))
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                        jPanel1Layout.createSequentialGroup()
                                                .addGroup(jPanel1Layout
                                                        ...
                                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                                                .addGap(63, 63, 63).addComponent(cbxParalelo,
                                                                        javax.swing.GroupLayout.PREFERRED_SIZE, 196,
                                                                        javax.swing.GroupLayout.PREFERRED_SIZE)))
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(jButton3))
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addComponent(jLabel13, javax.swing.GroupLayout.PREFERRED_SIZE, 57,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                ...
                                .addGroup(jPanel1Layout
                                        ...
                                        .addGroup(jPanel1Layout
                                                ...
                                                .addComponent(
                                                        jLabel12, javax.swing.GroupLayout.Alignment.LEADING,
                                        ...
                                        .addGroup(jPanel1Layout
                                                ...
                                                .addComponent(cbxDocente, 0, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        Short.MAX_VALUE)))
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGroup(jPanel1Layout
                                                .createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                                ...
                                                .addComponent(
                                                        jLabel6, javax.swing.GroupLayout.Alignment.LEADING,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addGroup(jPanel1Layout
                                                ...
                                                .addComponent(cbxMateria, 0, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        Short.MAX_VALUE))))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanel1Layout.createSequentialGroup().addComponent(jLabel9).addGap(5, 5, 5)
        ...
        jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel1Layout
                                                ...
                                                .addGroup(jPanel1Layout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                        .addComponent(jLabel11).addComponent(cbxTipoOrden,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE)))
                                        .addComponent(btnOrdenar, javax.swing.GroupLayout.Alignment.TRAILING))
                                .addComponent(cbxOrden, javax.swing.GroupLayout.Alignment.TRAILING,
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup().addGap(1, 1, 1)
                                        .addGroup(jPanel1Layout
                                                ...
                                                .addComponent(cbxTipoBusqueda, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addComponent(jLabel3).addComponent(txtCodigoCursa,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGap(7, 7, 7)))
                        .addGroup(
                                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout
                                                ...
                                                .addGroup(jPanel1Layout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                        .addComponent(jLabel5).addComponent(cbxParalelo,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                                .addComponent(jButton3))
                                                ...
                                                .addGroup(jPanel1Layout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                        .addComponent(jLabel14).addComponent(cbxDocente,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addGroup(jPanel1Layout
                                                        ...
                                                        .addGroup(jPanel1Layout
                                                                .createParallelGroup(
                                                                        javax.swing.GroupLayout.Alignment.BASELINE)
                                                                .addComponent(jLabel6).addComponent(txtMateriaBusqueda,
                                                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                                        .addComponent(jButton4))
                                                ...
                                                .addGroup(jPanel1Layout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                        .addComponent(jLabel15).addComponent(cbxMateria,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(btnAsignarMateria).addComponent(btnModificar).addComponent(btnEliminar)
    ...
    private void btnAsignarMateriaActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnAsignarMateriaActionPerformed
        ...
        try {
            if (cbxParalelo.getSelectedIndex() == -1) {
                JOptionPane.showMessageDialog(null, "Falta seleccionar el paralelo", "Error",
                        JOptionPane.WARNING_MESSAGE);
            }
            else if (cbxMatricula.getSelectedIndex() == -1) {
                JOptionPane.showMessageDialog(null, "Falta seleccionar la matricula", "Error",
                        JOptionPane.WARNING_MESSAGE);
            }
            else if (cbxDocente.getSelectedIndex() == -1) {
                JOptionPane.showMessageDialog(null, "Falta seleccionar el docebte", "Error",
                        JOptionPane.WARNING_MESSAGE);
            }
            else if (cbxMateria.getSelectedIndex() == -1) {
                JOptionPane.showMessageDialog(null, "Falta seleccionar la materia", "Error",
                        JOptionPane.WARNING_MESSAGE);
            }
            else {
                Guardar();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton6ActionPerformed
        ...
        try {
            if (txtMatriculaBusqueda.getText().isEmpty()) {
                UtilVista.cargarcomboMatricula(cbxMatricula);
                JOptionPane.showMessageDialog(null, "Ingrese la matricula a buscar", "FALTA LLENAR",
                        JOptionPane.WARNING_MESSAGE);
            }
            else {
                ...
                ListaDinamica<Matricula> ResultadoCodigo = UtilesControlador.BusquedaLineal(lista, Campo,
                        "CodigoMatricula");
                ResultadoBusqueda.concatenar(ResultadoCodigo);

                ListaDinamica<Matricula> ResultadoCedula = UtilesControlador.BusquedaLineal(lista, Campo,
                        "alumnoMatricula.DatosAlumno.NumeroCedula");
                ResultadoBusqueda.concatenar(ResultadoCedula);

                ListaDinamica<Matricula> ResultadoN = UtilesControlador.BusquedaLineal(lista, Campo,
                        "alumnoMatricula.DatosAlumno.Nombre");
                ResultadoBusqueda.concatenar(ResultadoN);

                ListaDinamica<Matricula> ResultadoA = UtilesControlador.BusquedaLineal(lista, Campo,
                        "alumnoMatricula.DatosAlumno.Apellido");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton5ActionPerformed
        ...
        try {
            if (txtDocenteBusqueda.getText().isEmpty()) {
                UtilVista.cargarcomboDocente(cbxDocente);
                JOptionPane.showMessageDialog(null, "Ingrese el docente a buscar", "FALTA LLENAR",
                        JOptionPane.WARNING_MESSAGE);
            }
            else {
                ...
                ListaDinamica<Docente> ResultadoCe = UtilesControlador.BusquedaLineal(lista, Campo,
                        "DatosDocente.NumeroCedula");
                ResultadoBusqueda.concatenar(ResultadoCe);

                ListaDinamica<Docente> ResultadoN = UtilesControlador.BusquedaLineal(lista, Campo,
                        "DatosDocente.Nombre");
                ResultadoBusqueda.concatenar(ResultadoN);

                ListaDinamica<Docente> ResultadoA = UtilesControlador.BusquedaLineal(lista, Campo,
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            if (txtMateriaBusqueda.getText().isEmpty()) {
                ...
                ListaDinamica<Materia> ResultadoBusqueda = UtilesControlador.BusquedaLineal(lista, Campo,
                        "NombreMateria");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaGestionCurso.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
        }
