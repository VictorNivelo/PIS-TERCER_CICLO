...
public class ModeloTablaCurso extends AbstractTableModel {
    ...
    public Object getValueAt(int Fila, int Columna) {
        try {
            ...
            case 4:
                return (p != null)
                        ? p.getMatriculaCursa().getAlumnoMatricula().getDatosAlumno().getNombre() + " "
                                + p.getMatriculaCursa().getAlumnoMatricula().getDatosAlumno().getApellido()
                        : "";
            case 5:
            ...
            case 7:
                return (p != null)
                        ? p.getDocenteCursa().getDatosDocente().getNombre() + " "
                                + p.getDocenteCursa().getDatosDocente().getApellido()
                        : "";
            case 8:
        ...
        // case 2:
        // return (p != null) ?
        // p.getListaMatriculaCursa().getInfo(Fila).getAlumnoMatricula().getDatosAlumno().getNumeroCedula():
        // "";
        // case 3:
        // return (p != null) ?
        // p.getListaMatriculaCursa().getInfo(Fila).getEstadoMatricula(): "";
        // case 4:
        // return (p != null) ?
        // p.getListaMatriculaCursa().getInfo(Fila).getCodigoMatricula(): "";
        // case 5:
        ...
        // case 2:
        // return (p != null) ?
        // p.getMatriculaCursa().getAlumnoMatricula().getDatosAlumno().getNumeroCedula():
        // "";
        // case 3:
