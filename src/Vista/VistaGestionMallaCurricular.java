...
public class VistaGestionMallaCurricular extends javax.swing.JFrame {
        ...
        if (fila < 0) {
            ...
            try {
                ...
                cbxCarrera.setSelectedIndex(
                        mallaControlDao.getMallaCurricular().getCarreraMallaCurricula().getIdCarrera() - 1);
            }
            catch (Exception e) {
    ...
    private boolean mallaExiste(MallaC nuevaMalla) {
        ...
        for (MallaC m : mallas.toArray()) {
            if (m.getNombreMallaCurricular().equals(nuevaMalla.getNombreMallaCurricular())
                    ...
                    && m.getCarreraMallaCurricula().getIdCarrera()
                            .equals(nuevaMalla.getCarreraMallaCurricula().getIdCarrera())) {
                return true;
            }
        }
        return false;
    ...
    private void Guardar() throws ListaVacia {
        if (txtNombreMalla.getText().isEmpty()) {
            ...
            JOptionPane.showMessageDialog(null, "Falta seleccionar el estado de la malla", "Error",
            ...
            if (mallaExiste(nuevaMalla)) {
                JOptionPane.showMessageDialog(null, "La malla curricular ya existe", "MALLA CURRICULAR EXISTENTE",
            ...
            try {
                ...
                if (mallaControlDao.Persist()) {
                    JOptionPane.showMessageDialog(null, "MALLA CURRICULAR GUARDADA EXITOSAMENTE", "INFORMACION",
                            JOptionPane.INFORMATION_MESSAGE);
                    mallaControlDao.setMallaCurricular(null);
                }
                else {
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel3Layout.createSequentialGroup().addGap(150, 150, 150)
                        ...
                        .addGap(18, 18, 18).addComponent(jLabel2).addContainerGap(135, Short.MAX_VALUE)));
        ...
        tblMalla.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
        ...
        cbxTipoBusqueda.setModel(new javax.swing.DefaultComboBoxModel<>(
                new String[] { "Nombre", "Duracion", "Estado de malla", "Carrera" }));
        cbxTipoBusqueda.setSelectedIndex(-1);
        ...
        jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel2Layout.createSequentialGroup().addContainerGap().addGroup(jPanel2Layout
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(jLabel6, javax.swing.GroupLayout.PREFERRED_SIZE, 304,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel2Layout
                                                ...
                                                .addComponent(cbxEstadoMalla, javax.swing.GroupLayout.Alignment.LEADING,
                                                        0, 241, Short.MAX_VALUE)
                                                .addComponent(cbxCarrera, 0, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        Short.MAX_VALUE)))))
                                ...
                                jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel2Layout.createSequentialGroup().addGroup(jPanel2Layout
                                                ...
                                                .addComponent(cbxTipoBusqueda, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addComponent(jButton6).addComponent(jLabel9).addComponent(txtBuscar,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        ...
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                .addGroup(jPanel2Layout
                                                        ...
                                                        .addComponent(jLabel3).addComponent(
                                                                txtNombreMalla, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addGroup(jPanel2Layout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                        .addComponent(jLabel4).addComponent(txtDuracionMalla,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addGroup(jPanel2Layout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                        .addComponent(jLabel11).addComponent(cbxEstadoMalla,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addGroup(jPanel2Layout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                        .addComponent(jLabel5).addComponent(cbxCarrera,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaGestionMallaCurricular.class.getName())
