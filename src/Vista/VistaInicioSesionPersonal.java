 ...
 * @author Victor
 */
public class VistaInicioSesionPersonal extends javax.swing.JFrame {
    personaDao personaControlDao = new personaDao();

    /**
     * Creates new form VistaInicioSecionPersonal
     */
    public VistaInicioSesionPersonal() {
        initComponents();
                ...
                if (rolPersona != null) {
                    if (rolPersona.getNombreRol().equals("Personal Administrativo")) {
                        ...
                        JOptionPane.showMessageDialog(null,
                                "Inicio de sesión fallido. Solo se permite el acceso a personal administrativo.",
    ...
    private void initComponents() {
        ...
        setTitle("SERVICIO DE AUTENTIFICACION DE PERSONAL");
        ...
        bordesRedondos1Layout.setHorizontalGroup(
                bordesRedondos1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                        ...
                        bordesRedondos1Layout.createSequentialGroup().addContainerGap(24, Short.MAX_VALUE)
        ...
        bordesRedondos1Layout.setVerticalGroup(bordesRedondos1Layout
                ...
                .addGroup(bordesRedondos1Layout.createSequentialGroup().addGap(24, 24, 24).addComponent(jLabel3)
        ...
        jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup().addGap(420, 420, 420).addComponent(
                                bordesRedondos1, javax.swing.GroupLayout.PREFERRED_SIZE,
                                javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaInicioSesionPersonal.class.getName())
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaInicioSesionPersonal().setVisible(true);
            }
        });
    }
