...
public class VistaGestionMateria extends javax.swing.JFrame {
    ...
    private void Guardar() throws ListaVacia {
        if (txtNombreMateria.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Falta llenar el nombre de la materia", "Error",
                    JOptionPane.WARNING_MESSAGE);
        }
        else if (txtNombreDescripcion.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Falta llenar la descripción de la materia", "Error",
                    JOptionPane.WARNING_MESSAGE);
        }
        else if (txtNumeroHoras.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Falta llenar el número de horas de la materia", "Error",
                    JOptionPane.WARNING_MESSAGE);
        }
        else if (cbxCiclo.getSelectedIndex() == -1) {
            JOptionPane.showMessageDialog(null, "Falta seleccionar el ciclo de la materia", "Error",
                    JOptionPane.WARNING_MESSAGE);
        }
        else {
            ...
            if (materiaExiste(nuevaMateria)) {
                ...
                try {
                    ...
                    if (materiaControlDao.Persist()) {
                        JOptionPane.showMessageDialog(null, "Materia guardada exitosamente", "Información",
                                JOptionPane.INFORMATION_MESSAGE);
                        Limpiar();
                    }
                    else {
                        JOptionPane.showMessageDialog(null, "No se pudo guardar la materia", "Error",
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel2Layout.createSequentialGroup().addGap(150, 150, 150)
                        ...
                        .addGap(48, 48, 48).addComponent(jLabel2)
        ...
        tblMaterias.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
        ...
        cbxTipoBusqueda.setModel(new javax.swing.DefaultComboBoxModel<>(
                new String[] { "Nombre", "Descripcion", "Numero de horas", "Ciclo" }));
        cbxTipoBusqueda.setSelectedIndex(-1);
                ...
                .addGroup(jPanel1Layout.createSequentialGroup().addContainerGap()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout
                                                ...
                                                .addComponent(txtNombreDescripcion).addComponent(txtNumeroHoras)
                                                .addComponent(cbxCiclo, 0, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        Short.MAX_VALUE)))
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                                        jPanel1Layout.createSequentialGroup().addGap(634, 634, 634)
                ...
                .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        ...
                                        .addComponent(txtNombreMateria, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        ...
                                        .addComponent(cbxTipoBusqueda, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jLabel9).addComponent(txtBuscar,
                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addComponent(jButton1))
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout
                                                ...
                                                .addComponent(btnRegresar).addComponent(btnGuardarMateria)))
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGroup(jPanel1Layout
                                                .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                .addComponent(jLabel5).addComponent(txtNombreDescripcion,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addGroup(jPanel1Layout
                                                .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                .addComponent(jLabel3).addComponent(txtNumeroHoras,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addGroup(jPanel1Layout
                                                ...
                                                .addComponent(cbxCiclo, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnModificarActionPerformed
        ...
        if (fila < 0) {
            ...
            if (txtNombreMateria.getText().isEmpty()) {
                JOptionPane.showMessageDialog(null, "Nombre de materia vacio", "CAMPO VACIO",
                        JOptionPane.WARNING_MESSAGE);
            }
            else if (txtNombreDescripcion.getText().isEmpty()) {
                JOptionPane.showMessageDialog(null, "Descripcion vacia", "CAMPO VACIO", JOptionPane.WARNING_MESSAGE);
                ...
                JOptionPane.showMessageDialog(null, "Falta llenar numero de horas", "Error",
                        JOptionPane.WARNING_MESSAGE);
            }
            else {
                // Datos de materia
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaGestionMateria.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
        }
