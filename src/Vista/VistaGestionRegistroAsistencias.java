...
public class VistaGestionRegistroAsistencias extends javax.swing.JFrame {
            ...
            if (idDocenteLogeado == idDocenteMateria) {
                ...
                if (curso.getMateriaCursa().equals(materiaSeleccionada)) {
                    for (Horario horario : listaHorarios.toArray()) {
                        if (Objects.equals(horario.getMateriaHorario().getIdMateria(),
        ...
        try {
            ...
            for (Object dato : datosLista) {
                if (dato instanceof Persona) {
                    ...
                    dtm.addRow(new Object[] { persona.getIdPersona(), persona.getNumeroCedula(), persona.getNombre(),
                            persona.getApellido(), true });
                }
            }
        }
        catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel2Layout.createSequentialGroup().addGap(150, 150, 150).addComponent(jLabel1)
        ...
        cbxTipoBusqueda
                .setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nombre", "Apellido", "Numero DNI" }));
        ...
        btnVerRegistro.setIcon(
                new javax.swing.ImageIcon(getClass().getResource("/Vista/RecursosGraficos/Botones/VerRegistro.png"))); // NOI18N
        ...
        tblRegistroAsistencia.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
        ...
        jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(jPanel1Layout.createSequentialGroup().addContainerGap().addGroup(jPanel1Layout
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel1Layout
                                                ...
                                                .addComponent(jLabel13, javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                                .addComponent(jLabel10, javax.swing.GroupLayout.DEFAULT_SIZE, 52,
                                                        Short.MAX_VALUE))
                                ...
                                .addGroup(jPanel1Layout
                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(DateFechaSeleccionada, javax.swing.GroupLayout.DEFAULT_SIZE, 229,
                                                Short.MAX_VALUE)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup().addGap(3, 3, 3).addGroup(jPanel1Layout
                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(jPanel1Layout
                                                ...
                                                .addGroup(jPanel1Layout.createSequentialGroup().addComponent(jLabel5)
                                                        ...
                                                        .addComponent(txtBuscar, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                563, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                        .addPreferredGap(
                                                                javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout
                                        ...
                                        .addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout
                                                ...
                                                .addComponent(cbxTipoOrden, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addComponent(jLabel8)).addGap(7, 7, 7))
                                        ...
                                        .addGroup(jPanel1Layout
                                                .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                .addComponent(jLabel13).addComponent(jLabel5)
                                                ...
                                                .addComponent(txtBuscar, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addComponent(cbxMateria, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGroup(jPanel1Layout.createSequentialGroup().addComponent(btnOrdenar)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(jButton1)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout
                                        ...
                                        .addComponent(jLabel10, javax.swing.GroupLayout.PREFERRED_SIZE, 26,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(DateFechaSeleccionada, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addGroup(jPanel1Layout
                                                .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                .addComponent(jLabel11).addComponent(cbxHorario,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGap(0, 0, Short.MAX_VALUE)))
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                .addComponent(jButton2).addComponent(btnModificar).addComponent(btnVerRegistro))
                        .addContainerGap()));
        ...
        try {
            if (cbxTipoBusqueda.getSelectedIndex() == -1) {
                ...
                for (int i = 0; i < ResultadoBusqueda.getLongitud(); i++) {
                    ...
                    datos[i] = new Object[] { p.getIdAlumno(), p.getDatosAlumno().getNumeroCedula(),
                            p.getDatosAlumno().getNombre(), p.getDatosAlumno().getApellido(), };
                }
        ...
        try {
            if (cbxTipoOrden.getSelectedIndex() == -1) {
                ...
                for (int i = 0; i < ResultadoBusqueda.getLongitud(); i++) {
                    Alumno p = ResultadoBusqueda.getInfo(i);
                    datos[i] = new Object[] { p.getIdAlumno(), p.getDatosAlumno().getNumeroCedula(),
                            p.getDatosAlumno().getNombre(), p.getDatosAlumno().getApellido(), false };
                }
    ...
    private void btnVerRegistroActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnVerRegistroActionPerformed
        ...
        try {
            if (asistenciaControlDao == null) {
                ...
                if (cbxMateria.getSelectedIndex() == -1 || cbxHorario.getSelectedIndex() == -1
                        || DateFechaSeleccionada.getDate() == null) {
                    JOptionPane.showMessageDialog(null, "Por favor, seleccione la materia, el horario y la fecha",
                ...
                for (Asistencia asistencia : asistencias.toArray()) {
                    if (asistencia.getFechaAsistencia().equals(fechaFormateada)
                            ...
                            && asistencia.getHorarioAsistencia().getMateriaHorario().getIdMateria()
                                    .equals(selectedMateria.getIdMateria())) {
                ...
                if (data.isEmpty()) {
                    JOptionPane.showMessageDialog(null,
                            "No hay registros de asistencia para la fecha, horario y materia seleccionados",
            ...
            e.printStackTrace();
            JOptionPane.showMessageDialog(null, "Error al cargar los registros de asistencia", "Error",
                    JOptionPane.ERROR_MESSAGE);
        }

        // try {
        // if (cbxMateria.getSelectedIndex() == -1 || cbxHorario.getSelectedIndex() ==
        // -1 || DateFechaSeleccionada.getDate() == null) {
        // JOptionPane.showMessageDialog(null, "Por favor, seleccione la materia, el
        // horario y la fecha", "Error", JOptionPane.WARNING_MESSAGE);
        // return;
        // }
        //
        // Date selectedDate = DateFechaSeleccionada.getDate();
        ...
        // asistenciaControlDao.getListaAsistencia();
        //
        // List<Object[]> data = new ArrayList<>();
        // for (Asistencia asistencia : asistencias.toArray()) {
        // if (asistencia.getFechaAsistencia().equals(fechaFormateada)
        ...
        // rowData[0] = data.size() + 1;
        // rowData[1] =
        // asistencia.getAlumnoAsistencia().getDatosAlumno().getNumeroCedula();
        // rowData[2] = asistencia.getAlumnoAsistencia().getDatosAlumno().getNombre();
        // rowData[3] = asistencia.getAlumnoAsistencia().getDatosAlumno().getApellido();
        // rowData[4] = asistencia.getEstadoAsistencia().equals("Presente") ? "Presente"
        // : "Ausente";
        // data.add(rowData);
        // }
        // }
        //
        // if (data.isEmpty()) {
        // JOptionPane.showMessageDialog(null, "No hay registros de asistencia para la
        // fecha, horario y materia seleccionados", "Información",
        ...
        // catch (Exception e) {
        // e.printStackTrace();
        // JOptionPane.showMessageDialog(null, "Error al cargar los registros de
        // asistencia", "Error", JOptionPane.ERROR_MESSAGE);
        // }
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnModificarActionPerformed
        ...
        if (fila < 0) {
            ...
            if (cbxMateria.getSelectedIndex() == -1 || DateFechaSeleccionada.getDate() == null
                    || cbxHorario.getSelectedIndex() == -1) {
                JOptionPane.showMessageDialog(null, "Por favor, complete la selección de materia, fecha y horario",
                        "Error", JOptionPane.WARNING_MESSAGE);
            }
            else {
                try {
                    ...
                    if (alMenosUnaModificacion) {
                        JOptionPane.showMessageDialog(null, "Registros de asistencia modificados correctamente",
                        ...
                        JOptionPane.showMessageDialog(null, "No se han realizado modificaciones", "Advertencia",
                                JOptionPane.WARNING_MESSAGE);
                    }
                }
                catch (Exception e) {
                    e.printStackTrace();
                    JOptionPane.showMessageDialog(null, "Error al modificar los registros de asistencia", "Error",
                            JOptionPane.ERROR_MESSAGE);
                }
            }
        }
        ...
        // JOptionPane.showMessageDialog(null, "Falta seleccionar la fecha", "Error",
        // JOptionPane.WARNING_MESSAGE);
        // }
        // else if (cbxHorario.getSelectedIndex() == -1) {
        // JOptionPane.showMessageDialog(null, "Falta seleccionar el horario", "Error",
        // JOptionPane.WARNING_MESSAGE);
        // }
        // else {
        // for (int i = 0; i < tblRegistroAsistencia.getRowCount(); i++) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaGestionRegistroAsistencias.class.getName())
